...
use PhacMan\HttpMessage\Uri;
use PHPUnit\Framework\TestCase;

/**
 * @covers \PhacMan\HttpMessage\Uri
 */
class UriTest extends TestCase
{
     ...
     * @param mixed  $output
     */
    public function testUriComponentsGetEncodedProperly(string $input, mixed $path, mixed $query, mixed $fragment, mixed $output): void
    {
        $uri = new Uri($input);
