...
use PhacMan\HttpMessage\Response;
use PHPUnit\Framework\TestCase;
use Psr\Http\Message\StreamInterface;

/**
 * @covers \PhacMan\HttpMessage\MessageTrait
 * @covers \PhacMan\HttpMessage\Response
 */
class ResponseTest extends TestCase
{
    ...
    {
        $b = (new \PhacMan\HttpMessage\HttpFactory())->createStream('0');
